...
public abstract class BaseBot {
    ...
    /**
     * A Map of all methods annotated with {@link BotController} where key is the {@link EventType#name()} and
    ...
    /**
     * A Map of all methods annotated with {@link BotController} where key is the {@link Method#getName()} and
     ...
     * can be chained into a conversation by {@link BotController#next()}.
     */
    ...
    public BaseBot() {
        ...
        for (Method method : methods) {
            if (method.isAnnotationPresent(BotController.class)) {
                BotController controller = method.getAnnotation(BotController.class);
    ...
    /**
     * Search for a method whose {@link BotController#pattern()} match with the {@code Event} text or payload
     * received from Slack/Facebook and also filter out the methods in {@code methodWrappers} whose 
     * {@link BotController#pattern()} do not match.
     *
    ...
    /**
     * Wrapper class for methods annotated with {@link BotController}.
     */
