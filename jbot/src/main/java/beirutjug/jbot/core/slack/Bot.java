...
public abstract class Bot extends BaseBot {
     ...
     * and {@link BotController#pattern()} in events received from Slack.
     *
     * @param session websocket session between bot and slack
     * @param event received from slack
     */
