package beirutjug.jbot.core.facebook;
...
import beirutjug.jbot.core.common.BaseBot;
import beirutjug.jbot.core.common.BotController;
import beirutjug.jbot.core.common.EventType;
import beirutjug.jbot.core.facebook.models.Callback;
import beirutjug.jbot.core.facebook.models.Entry;
import beirutjug.jbot.core.facebook.models.Event;
import beirutjug.jbot.core.facebook.models.Message;
import beirutjug.jbot.core.facebook.models.Payload;
import beirutjug.jbot.core.facebook.models.Postback;
import beirutjug.jbot.core.facebook.models.Response;
import beirutjug.jbot.core.facebook.models.User;
...
public abstract class Bot extends BaseBot {
    ...
    /**
     * Invoke the methods with matching {@link BotController#events()}
     * and {@link BotController#pattern()} in events received from Slack/Facebook.
     *
     * @param event received from facebook
     */
    ...
    private void invokeChainedMethod(Event event) {
        ...
        if (queue != null && !queue.isEmpty()) {
            ...
            try {
                EventType[] eventTypes = methodWrapper.getMethod().getAnnotation(BotController.class).events();
