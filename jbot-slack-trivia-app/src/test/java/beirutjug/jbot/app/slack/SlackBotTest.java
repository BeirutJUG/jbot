...
import beirutjug.jbot.core.slack.SlackService;
...
public class SlackBotTest {
    ...
    public static class TestBot extends Bot {
        ...
        @BotController(next = "askWhetherToRepeat")
